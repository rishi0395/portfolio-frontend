...
import './about.css';
export default class ManOnTable extends Component {
  render() {
    const theme = {
      color: 'rgb(0, 7, 45)',
      jacket: 'rgb(0, 7, 45)',
      hair: 'rgb(0, 7, 45)',
      pant: 'rgb(0,7,45)',
      shirt: 'rgb(14, 107, 168)',
      tableCupboard: '#b8797d'
    };
    const { shirt, color, jacket, hair, pant, tableCupboard } = theme;
    return (
      <svg
      ...
      >
        ...
        <path
          ...
          fill={jacket}
        />
        <circle cx='331.55' cy='263.33' r='1.95' fill={pant} />
        <path
        ...
        <circle cx='335.45' cy='324.89' r='1.95' fill={pant} />
        <path
        ...
        <circle cx='329.6' cy='231.76' r='1.95' fill={pant} />
        <circle cx='342.07' cy='354.9' r='1.95' opacity='0.1' />
        <circle cx='342.07' cy='354.12' r='1.95' fill={pant} />
        <circle cx='335.45' cy='387.24' r='1.95' opacity='0.1' />
        <circle cx='335.45' cy='386.46' r='1.95' fill={pant} />
        <path
